...
##Extract NK cell and CD8+ T cell as reference cells
index <- which(data.merge@meta.data$cellType %in% c("CD8+ T cell", "NK cell"))
...
infercnv_obj = CreateInfercnvObject(raw_counts_matrix= "/data/activate_data/longzhilin/RenalTumor-20200713/inferCNV_result/RNA_20210803/countmatrix.txt",
                                    ...
                                    ref_group_names=c("CD8+ T cell", "NK cell"))
