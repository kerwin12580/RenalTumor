...
order.value <- c("CD4+ T cell", "Treg", paste0("CD8+ T-", levels(CD8.T$cellType3)), "Proliferative T cell", "NK cell", "B cell",
...
idx <- which(selected_rows %in% c("ITGB2_VCAM1", "ITGB1_TIMP2", "CD99_CD81","TIMP1_CD63", "ITGB1_SPP1", "ITGA5_SPP1", "ITGB1_VEGFA", "CP_SLC40A1", "EGFR_ANXA1",
                                  ...
                                  "TNFRSF1B_GRN", "VIM_CD44", "VEGFA_ITGA9", "SPP1_ITGA4", "SPP1_PTGER4", "S100A8_CD68", "S100A9_CD68",
                                  "VEGFA_FLT1", "TLR4_HSPA1A", "PKM_CD44", "SPP1_ITGA9"))
selected_rows <- selected_rows[-idx]
selected_rows <- unique(c(selected_rows, "CD24_SIGLEC10", "C5AR1_RPS19", "ERBB2_HSP90AA1", "HLA-F_B2M",
                   "SERPINE1_PLAUR", "CXCL2_DPP4", "CXCL14_CXCR4",
                   "INSR_NAMPT", "ITGAL_LYZ", "IL1B_SIGIRR", "CXCL8_SDC2", "VEGFA_EPHB2"))
...
idx <- which(selected_rows %in% c("ITGAV_VEGFA", "ITGB1_VCAM1", "ITGB2_VCAM1", "TIMP1_CD63", "SPP1_PTGER4", "ITGA5_SPP1", "ARPC5_LRP2", "CD3G_B2M", "SPP1_ITGA4",
                                  "ITGB1_SPP1", "EGFR_S100A4", "ERBB2_S100A4", "SPP1_CD44", "SPP1_ITGA4", "S100A8_CD69", "PKM_CD44", "CD74_MIF", "PTPRC_LGALS1",
                                  "PTPRC_LGALS1", "RPSA_LAMB2", "HSP90AA1_LRP1", "EZR_VCAM1", "CD3D_B2M", "CD3G_B2M", "TFRC_B2M", "CD247_B2M", "EGFR_CALM2",
                                  "HLA-F_B2M", "MIF_CXCR4", "MIF_CD44", "CD2_CD58", "EGFR_MIF", "VIM_CD44", "HSPA8_LRP2", "CALR_HLA-F", "HMMR_CALM1",
                                  "CALM1_FAS", "CALM2_AQP1", "EGFR_HSP90AA1", "ERBB2_HSP90AA1"))
selected_rows <- selected_rows[-idx]
selected_rows <- unique(c(selected_rows, "ITGB1_LGALS1", "CD27_CD70", "CD2_CD59", "CD2_CD48", "HMGB1_CXCR4", "NRP1_VEGFA",
                  "TGFB1_CXCR4", "CD74_APP", "APP_RPSA", "VEGFA_FLT1", "CALM2_AQP1", "LTBR_LTB", 
                  "CD99_CD81"))
...
pdf("Tumor/Lymphoid/tumor.Lymphoid.interaction.receptor.pdf", width = 3.65, height = 4)
p1 <- dot_plot(selected_rows = selected_rows1, selected_columns = unique(selected_columns1), 
