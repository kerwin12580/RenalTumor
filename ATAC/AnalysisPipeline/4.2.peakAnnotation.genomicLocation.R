...
tumor.up.distal <- tumor.up.distal[c(2, 5, 9, 15),]
pdf("4.Peak/bed/GREAT.Tumor.selection.pdf", height = unit(5, "inches"))
p <- ggbarplot(tumor.up.proximal, x = "wrap", y = "Hyper_Fold_Enrichment", fill = "grey", color = "grey", width = 0.4, xlab = "", orientation = "horiz", sort.val = c("asc"))+theme(legend.position="none")
print(p)
