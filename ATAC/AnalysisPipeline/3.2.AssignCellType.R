...
plot.cellType <- c("CD4+ T cell", "Treg", "CD8+ T cell", "NK cell", "B cell", "Macrophage", "Monocyte", "Mast cell", "Endothelium (VCAM1+)", "Endothelium (VCAM1-)", "Mesangial cell", "Tumor")
